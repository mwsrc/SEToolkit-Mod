...
def show_banner(define_version,graphic):
  ...
  [---]          Codename: '""" + bcolors.YELLOW + """MMMMhhhhmmmmmmmmm""" + bcolors.BLUE + """'           [---]
  [---]        Report """ + bcolors.RED +"""bugs""" + bcolors.BLUE + """:"""+ bcolors.GREEN + """ davek@trustedsec.com    """ + bcolors.BLUE+"""     [---]
...
""" + bcolors.GREEN+"""   Welcome to the Social-Engineer Toolkit (SET). Your one
    ...
    """ 
        ...
        print bcolors.BOLD + """  The Social-Engineer Toolkit is a product of TrustedSec.\n\n           Visit: https://www.""" + bcolors.GREEN + bcolors.BOLD + """trusted""" + bcolors.RED +  """sec""" + bcolors.ENDC + bcolors.BOLD + """.com\n""" + bcolors.ENDC
...
def generate_powershell__alphanumeric_payload(payload,ipaddr,port):
