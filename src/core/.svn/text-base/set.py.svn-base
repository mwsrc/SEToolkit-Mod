      ...
      while 1:
        ...
        if attack_vector == "7":
            ...
            for line in fileopen:
                ...
                if match:
                    print_warning("Apache mode is set to ON, you cannot use Multi-Attack Mode with Apache")
                    print_warning("Turn off APACHE_SERVER=ON in the SET_CONFIG and relaunch SET")
                    attack_vector = "30"
