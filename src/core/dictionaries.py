...
def ms_module(exploit):
    ...
    return {
            '1':"exploit/multi/browser/java_atomicreferencearray",
	    '2':"exploit/multi/browser/java_verifier_field_access",
            '3':"exploit/windows/browser/ms12_037_same_id",
            '4':"exploit/windows/browser/msxml_get_definition_code_exec",
            '5':"exploit/windows/browser/adobe_flash_rtmp",
            '6':"exploit/windows/browser/adobe_flash_mp4_cprt",
            '7':"exploit/windows/browser/ms12_004_midi",
            '8':"multi/browser/java_rhino\nset target 1",
            '9':"windows/browser/ms11_050_mshtml_cobjectelement",
            '10':"windows/browser/adobe_flashplayer_flash10o",
            '11':"windows/browser/cisco_anyconnect_exec",
            '12':"windows/browser/ms11_003_ie_css_import",
            '13':"windows/browser/wmi_admintools",
            '14':"windows/browser/ms10_090_ie_css_clip",
            '15':"windows/browser/java_codebase_trust",
            '16':"windows/browser/java_docbase_bof",
            '17':"windows/browser/webdav_dll_hijacker",
            '18':"windows/browser/adobe_flashplayer_avm",
            '19':"windows/browser/adobe_shockwave_rcsl_corruption",
            '20':"windows/browser/adobe_cooltype_sing",
            '21':"windows/browser/apple_quicktime_marshaled_punk",
            '22':"windows/browser/ms10_042_helpctr_xss_cmd_exec",
            '23':"windows/browser/ms10_018_ie_behaviors",
            '24':"windows/browser/ms10_002_aurora",
            '25':"windows/browser/ms10_018_ie_tabular_activex",
            '26':"windows/browser/ms09_002_memory_corruption",
            '27':"windows/browser/ms09_072_style_object",
            '28':"windows/browser/ie_iscomponentinstalled",
            '29':"windows/browser/ms08_078_xml_corruption",
            '30':"windows/browser/ie_unsafe_scripting",
            '31':"multi/browser/firefox_escape_retval",
            '32':"windows/browser/mozilla_mchannel",
            '33':"auxiliary/server/browser_autopwn",
           }.get(exploit,"ERROR")
